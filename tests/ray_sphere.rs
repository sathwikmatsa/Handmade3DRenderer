...
fn ray_sphere_intersection_two() {
    ...
    let xs : Vec<f32> = ray.intersect(&sphere);
    assert_eq!(xs.len(), 2);
    assert!(float_cmp::equal(xs[0], 4.0));
    assert!(float_cmp::equal(xs[1], 6.0));
}
...
fn ray_sphere_tangent_intersection() {
    ...
    let xs : Vec<f32> = ray.intersect(&sphere);
    assert_eq!(xs.len(), 2);
    assert!(float_cmp::equal(xs[0], 5.0));
    assert!(float_cmp::equal(xs[1], 5.0));
}
...
fn ray_originates_inside_sphere() {
    ...
    let xs : Vec<f32> = ray.intersect(&sphere);
    assert_eq!(xs.len(), 2);
    assert!(float_cmp::equal(xs[0], -1.0));
    assert!(float_cmp::equal(xs[1], 1.0));
}
#[test]
fn sphere_behind_ray() {
    ...
    let xs : Vec<f32> = ray.intersect(&sphere);
    assert_eq!(xs.len(), 2);
    assert!(float_cmp::equal(xs[0], -6.0));
    assert!(float_cmp::equal(xs[1], -4.0));
}
